<section class="work-section work5-section scr-section scr-section7 scr-section7-scr" data-n="7">
  <div class="bg-main bg-main5"></div>
  <div class="bg"></div>
  <div class="work">
    <div class="work-contents">
      <div class="mockup-all">
        <div class="mockup-c">
          <div class="screenshot-c">
            <img src="./img/work/work2/ex.png" alt="서야궁 데스크탑이미지"><!-- 컴퓨터안 이미지 -->
          </div><!-- screenshot -->
          <p class="frame-c"></p>
        </div><!-- mockup-c -->
        <div class="mockup-m">
          <div class="screenshot-m">
            <img src="./img/work/work2/ex-m.png" alt="서양궁 모바일 이미지"><!-- 컴퓨터안 이미지 -->
          </div><!-- screenshot -->
          <p class="frame-m"></p>
        </div><!-- mockup-m -->
      </div><!-- mockup-all -->
      ...
      <div class="mockup-desc">
        ...
        <div class="link">
          <button data-n="5">Planning</button>
          <a href="http://ksm942300.dothome.co.kr" target="_blank">Website</a>
        </div>
      </div><!-- mockup-desc -->
    </div><!-- work-contents -->
  </div><!-- work1 -->
    ...
    <div class="wrap">
      ...
      <div class="main">
        <div class="overview">
          ...
          <div class="contents">
            <p>
            php환경의 멀티페이지 사이트 개발에 필요한 개발환경 구축 및 탬플릿 구조 설계방식을 학습하였습니다. <br>
            선호도가 높은 기업형 웹사이트 탬플릿(cafe24 유료 탬플릿)을 레퍼런스로 참고하였습니다. <br><br>
            svg와 스크롤 모션구현을 통해 심미성과 시각적 흥미 요소를 추가하고 미디어 쿼리와 제이쿼리를 이용해 <br>
            다양한 디바이스 환경 최적화 및 UX를 고려한 UI환경을 제공할 수 있는 반응형 웹사이트 리뉴얼 과정을 학습하고 <br>
            퍼블리싱에 필요한 기초기술을 습득하는데 목적을 두었습니다. </p>
          </div>
        </div>
        ...
        <script>
          FontArr2.forEach(function(v) {
            $(`.work5-section .typography`).append(`
              <div class="contents-wrap">
                <p>${v.name1}</p>
